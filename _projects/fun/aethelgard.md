...
<div class="row">
    <div class="col-sm mt-3 mb-3 text-center">
        {% include figure.liquid path="assets/img/local_intelligence_node.png" title="Aethelgard Node UI" class="img-fluid rounded z-depth-1" %}
    </div>
</div>


<a>https://github.com/akaliutau/aethelgard</a>
