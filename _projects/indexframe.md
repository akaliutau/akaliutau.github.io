...
img: /assets/img/logo_indexframe.jpg
importance: 6
category: fun
---
...
<div class="row">
  <div class="col-sm mt-3 mb-3 text-center">
    {% include figure.liquid path="assets/img/header_indexframe.png" title="IndexFrame Result Pack (emailed)" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
...
Read the whole story [here](https://devpost.com/software/indexframe)
